  ...
  return (
    <div>
      ...
      <main>
        <Script
          strategy="lazyOnload"
          src="https://embed.tawk.to/62aa379db0d10b6f3e778e23/1g5keig6q"
        />
        <section id="home">
                  ...
                  <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                    ...
                    >
                      ...
                      <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                        ...
                        <a
                          href="https://calendly.com/eng-m-alachkar/30min"
                          target="_blank"
                          rel="noreferrer"
                ...
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                  <div className="sm:text-center lg:text-left">
                    ...
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                      The future is green energy, sustainability, storing energy
                    </p>
                  ...
                  <div className="mt-8 lg:mt-0">
                    <div className="text-base max-w-prose mx-auto lg:max-w-none">
                      <p className="text-lg text-gray-500">
                        Anything that moves has kinetic energy, and scientists
                        and engineers are using the wind’s kinetic energy to
                        generate electricity. Wind energy, or wind power, is
                        created using a wind turbine, a device that channels the
                    ...
                    <div className="mt-5 prose prose-indigo text-lg space-y-4 text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
                      <p>
                        ...
                        create electricity. There are two types of wind
                        turbines: the horizontal-axis wind turbines (HAWTs) and
                        vertical-axis wind turbines (VAWTs).
                      </p>
                      <p>
                        Small, individual wind turbines can produce 100
                        kilowatts of power, enough to power a home. Small wind
                        turbines are also used for places like water pumping
                        stations. Slightly larger wind turbines sit on towers
                        that are as tall as 80 meters (260 feet) and have rotor
                        blades that extend approximately 40 meters (130 feet)
                        long. These turbines can generate 1.8 megawatts of
                        power. Even larger wind turbines can be found perched on
                        towers that stand 240 meters (787 feet) tall have rotor
                        blades more than 162 meters (531 feet) long. These large
                        turbines can generate anywhere from 4.8 to 9.5 megawatts
                        of power.
                      </p>
                      <p>
              ...
              <div className="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
                  ...
                  <div className="mt-8 lg:mt-0">
                    ...
                    <div className="mt-5 prose prose-indigo text-lg space-y-4 text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
                      <p>
                        The cells don’t need direct sunlight to work and can
                        even work on cloudy days. However, the stronger the
                      ...
                      <p className="underline">
                        ...
                        systems including cosultation, buying, and installing
                        the systems.
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative max-w-lg mx-auto   lg:max-w-7xl ">
              <div>
                <h2 className="text-3xl tracking-tight font-extrabold text-green-700 sm:text-4xl">
                  Self Powered Prefabricated Houses
                </h2>
                <p className="mt-3 text-xl text-gray-500 sm:mt-4">
                  The most complete version of prefabricated houses suitable
                  based on need.
                </p>
              </div>
              <div className="mt-12 grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-3 xl:gap-x-8">
